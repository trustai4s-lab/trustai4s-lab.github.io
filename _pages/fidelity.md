...
According to the Fidelity definition, there exists an Out-of-Distribution(OOD) problem that might cause inaccurate results because of the domain shift between original training data and explanation data. We select one figure from [(Zhuomin Chen et. al.)](https://arxiv.org/pdf/2402.02036.pdf) to illustrate this phenomenon.
<center class="ood">
<table>
  <tr>
